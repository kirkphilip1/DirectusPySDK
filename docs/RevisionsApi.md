...
# **get_revision**
> InlineResponse20037 get_revision(id, fields=fields, meta=meta)
...
# **get_revisions**
> InlineResponse20036 get_revisions(fields=fields, limit=limit, offset=offset, meta=meta, sort=sort, filter=filter, search=search, page=page)
