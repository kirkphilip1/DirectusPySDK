...
# **create_webhook**
> InlineResponse20039 create_webhook(body=body, fields=fields, meta=meta)
...
try:
    # Create a Webhook
    api_response = api_instance.create_webhook(body=body, fields=fields, meta=meta)
    pprint(api_response)
...
# **get_webhook**
> InlineResponse20045 get_webhook(id)
...
# **get_webhooks**
> InlineResponse20045 get_webhooks()
...
# **update_webhook**
> InlineResponse20039 update_webhook(id, body=body, fields=fields, meta=meta)
...
api_instance = swagger_client.WebhooksApi()
id = 'id_example' # str | Unique identifier for the object.
body = swagger_client.WebhooksIdBody() # WebhooksIdBody |  (optional)
fields = ['fields_example'] # list[str] | Control what fields are being returned in the object. (optional)
meta = 'meta_example' # str | What metadata to return in the response. (optional)

try:
    # Update a Webhook
    api_response = api_instance.update_webhook(id, body=body, fields=fields, meta=meta)
    pprint(api_response)
except ApiException as e:
...
# **update_webhooks**
> InlineResponse20046 update_webhooks(body=body, fields=fields, limit=limit, meta=meta, offset=offset, sort=sort, filter=filter, search=search)
...
# create an instance of the API class
api_instance = swagger_client.WebhooksApi()
body = swagger_client.WebhooksBody1() # WebhooksBody1 |  (optional)
fields = ['fields_example'] # list[str] | Control what fields are being returned in the object. (optional)
...
try:
    # Update Multiple Webhooks
    api_response = api_instance.update_webhooks(body=body, fields=fields, limit=limit, meta=meta, offset=offset, sort=sort, filter=filter, search=search)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling WebhooksApi->update_webhooks: %s\n" % e)
```
