...
# **create_items_logs**
> InlineResponse20048 create_items_logs(body=body, meta=meta)
...
# **read_items_logs**
> InlineResponse20047 read_items_logs(fields=fields, limit=limit, meta=meta, offset=offset, sort=sort, filter=filter, search=search)
...
> InlineResponse20050 read_single_items_logs(id, fields=fields, meta=meta, version=version)
...
# **update_items_logs**
> InlineResponse20049 update_items_logs(body=body, fields=fields, limit=limit, meta=meta, offset=offset, sort=sort, filter=filter, search=search)
...
> InlineResponse20050 update_single_items_logs(id, body=body, fields=fields, meta=meta)
