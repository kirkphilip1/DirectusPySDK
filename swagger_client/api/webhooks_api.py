...
class WebhooksApi(object):
    ...
    def delete_webhooks(self, **kwargs):  # noqa: E501
        """Delete Multiple Webhooks  # noqa: E501

        Delete multiple existing webhooks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_webhooks(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_webhooks_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.delete_webhooks_with_http_info(**kwargs)  # noqa: E501
            return data

    def delete_webhooks_with_http_info(self, **kwargs):  # noqa: E501
        """Delete Multiple Webhooks  # noqa: E501

        Delete multiple existing webhooks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_webhooks_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_webhook(self, id, **kwargs):  # noqa: E501
        ...
        Retrieve a single webhook by unique identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_webhooks(self, **kwargs):  # noqa: E501
        """Update Multiple Webhooks  # noqa: E501

        Update multiple webhooks at the same time.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_webhooks(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param WebhooksBody1 body:
        :param list[str] fields: Control what fields are being returned in the object.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_webhooks_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.update_webhooks_with_http_info(**kwargs)  # noqa: E501
            return data

    def update_webhooks_with_http_info(self, **kwargs):  # noqa: E501
        """Update Multiple Webhooks  # noqa: E501

        Update multiple webhooks at the same time.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_webhooks_with_http_info(async_req=True)
        >>> result = thread.get()
