...
class FoldersApi(object):
    ...
    def create_folder(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.create_folder_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def delete_folders(self, **kwargs):  # noqa: E501
        """Delete Multiple Folders  # noqa: E501

        Delete multiple existing folders.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_folders(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_folders_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.delete_folders_with_http_info(**kwargs)  # noqa: E501
            return data

    def delete_folders_with_http_info(self, **kwargs):  # noqa: E501
        """Delete Multiple Folders  # noqa: E501

        Delete multiple existing folders.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_folders_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_folder(self, id, **kwargs):  # noqa: E501
        ...
        Retrieve a single folder by unique identifier.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_folders(self, **kwargs):  # noqa: E501
        """Update Multiple Folders  # noqa: E501

        Update multiple folders at the same time.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_folders(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param FoldersBody1 body:
        :param list[str] fields: Control what fields are being returned in the object.
        :param int limit: A limit on the number of objects that are returned.
        :param str meta: What metadata to return in the response.
        :param int offset: How many items to skip when fetching data.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_folders_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.update_folders_with_http_info(**kwargs)  # noqa: E501
            return data

    def update_folders_with_http_info(self, **kwargs):  # noqa: E501
        """Update Multiple Folders  # noqa: E501

        Update multiple folders at the same time.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_folders_with_http_info(async_req=True)
        >>> result = thread.get()
